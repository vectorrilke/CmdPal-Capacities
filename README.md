...
### Microsoft Store
If the extension is not yet available through WinGet on your machine, you can also install it directly from the [Microsoft Store](ms-windows-store://pdp/?productid=9NSN399G59KM)
